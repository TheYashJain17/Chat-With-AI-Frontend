...
const AnimatedPlaceholder = ({ showSearch }: { showSearch: boolean }) => (
  <AnimatePresence mode="wait">
    ...
    >
      {/* {showSearch ? "Search the web..." : "Ask Chat Ai..."} */}
      {"Ask Chat Ai..."}
    </motion.p>
  </AnimatePresence>
)

export default function AiInput({setMessages}: {setMessages: React.Dispatch<React.SetStateAction<ChatMessageType[]>>}) {
        ...
        <div className="relative rounded-2xl border border-black/5 bg-neutral-800/5 flex flex-col">
          ...
          <div className="h-12 bg-black/5 dark:bg-white/5 rounded-b-xl">
            ...
            <div className="absolute right-3 bottom-3">
              ...
              >
                <Send className="w-4 h-4" onClick={handleSend}/>
              </button>
            </div>
          </div>
        </div>
